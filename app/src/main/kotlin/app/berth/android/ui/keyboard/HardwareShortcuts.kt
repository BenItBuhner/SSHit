 ...
 * chord nobody bound, and so is AltGr with a key that types under it, which the reader makes no
 * chord of unless the Leader is engaged with it (a remap onto Alt+Q fires on Left Alt+Q and leaves a
 * German keyboard its `@`; Right Ctrl with AltGr+Q is `Leader Alt+Q`, held or tapped). Two
