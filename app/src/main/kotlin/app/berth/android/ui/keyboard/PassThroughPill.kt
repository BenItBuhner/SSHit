 ...
 * header's 48 dp, grown upward by the [reach] the header lends its fixed slots and ending at the
 * row's foot, the way the count tile and the icon actions beside it are; to a screen reader one
 * button that says what it ends.
 */
@Composable
fun PassThroughPill(
    onEnd: () -> Unit,
