 ...
 * status-bar inset it owns ([app.berth.android.ui.tabs.reachUnder]), so a 40 dp row answers a
 * 48 dp target without the row growing. The header provides it; an icon action, count tile or bar action placed in the header
